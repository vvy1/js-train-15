...
function calculateCircleArea(radius) {
  ...
  if (typeof radius != "number" || radius <= 0) {
    ...
    console.log("Помилка: радіус має бути додатнім числом.");
    return null; // Повертаємо 0, щоб показати, що обчислення неможливе
  }
...
function findMinMax(numbers) {
  ...
  if (!Array.isArray(numbers) || numbers.length === 0) {
    ...
    console.log("Помилка: Вхідний параметр має бути непорожнім масивом чисел.");
...
function calculateHypotenuse(a, b) {
  ...
  if (typeof a != "number" || typeof b != "number" || a <= 0 || b <= 0) {
    ...
    console.log("Помилка: Катети мають бути додатними числами.");
    // Повертаємо null, що свідчить про неможливість обробки вхідних даних.
    return null;
  }
